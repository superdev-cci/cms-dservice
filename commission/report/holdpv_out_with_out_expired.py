...
class PvTransferOutWithOutExpiredReport(PeriodSummaryBase):
    class Meta:
        model = PvTransfer
        date_fields = 'sadate'
        filter = {
    ...
    def __init__(self, *args, **kwargs):
        super(PvTransferOutWithOutExpiredReport, self).__init__(*args, **kwargs)
    ...
    def filter_queryset(self, queryset):
        queryset = super(PvTransferOutWithOutExpiredReport, self).filter_queryset(queryset)
        if self.has_member:
