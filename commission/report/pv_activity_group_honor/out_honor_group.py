...
class PvTransferOutReport(PeriodSummaryBase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.members = {x.code: x for x in Member.objects.filter(honor=self.member_group)}
    ...
    def filter_queryset(self, queryset):
        ...
        member_codes = list(self.members.keys())
        return queryset.filter(uid__in=member_codes)
