...
from ..serializers import SaleMaintainSerializer
# from ..report import SummaryFastCommission


class SaleMaintainView(viewsets.ModelViewSet):
    queryset = MonthQualified.objects.all()
    serializer_class = SaleMaintainSerializer
