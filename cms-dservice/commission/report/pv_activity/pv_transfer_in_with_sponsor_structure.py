...
class PvTransferInWithSponsorStructureReport(PeriodSummaryBase):
    """
    a class represent member in sponsor tree receive PV from PvTransfer.
    ...
    def __init__(self, *args, **kwargs):
        super(PvTransferInWithSponsorStructureReport, self).__init__(*args, **kwargs)
    ...
    def filter_queryset(self, queryset):
        ...
        """
        queryset = super(PvTransferInWithSponsorStructureReport, self).filter_queryset(queryset)
